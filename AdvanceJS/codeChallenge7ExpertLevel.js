...
- Syntax (function(//If any agruments ){//Code Inside })(If any Arguements);
*/
...
Question.prototype.checkAnswer = function(answer, callbackFunc){
var sc;
    if(answer===this.correctAnswer){
        console.log("Correct Answer! :)")
        //This function is nothing but updScore function we passed in NextQUestion function 
        //Also the Score function is returing score value we need to store the below func in Variable
        sc = callbackFunc(true);
    }else{
        console.log("Incorrect Answer, Please try again!")
        sc = callbackFunc(false);
    }
    //Calling the displyScore function to display the score along with next Question
    this.displayScore(sc);

}

//Now create a new prototye to display the score
...
//This var return the function 
var updScore = score();
//Create a function To display the next question once the user enter the answer
...
function nextQuestion(){
    ...
    //Exit the Question when user enters the text 'exit'
    if(answer!=='exit'){
        //Now call the prototype to display the correct answer
        questions[quesNum].checkAnswer(answer,updScore);
        nextQuestion();
    }else{
...
//Calling to display the question for first time
nextQuestion();
